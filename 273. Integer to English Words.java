class IntegertoEnglishWords {
    ...
    private String helper(int num) {
        ...
        if (num < 10)
            ...
            r = belowTwenty[num - 10];
        else if (num < 100)
            r = belowHundred[num / 10] + " " + helper(num % 10);
        else if (num < 1000)
            r = helper(num / 100) + " Hundred " + helper(num % 100);
        else if (num < 1000000)
            r = helper(num / 1000) + " Thousand " + helper(num % 1000);
        else if (num < 1000000000)
            r = helper(num / 1000000) + " Million " + helper(num % 1000000);
        else
            r = helper(num / 1000000000) + " Billion " + helper(num % 1000000000);
        return r.trim();
    }
}
